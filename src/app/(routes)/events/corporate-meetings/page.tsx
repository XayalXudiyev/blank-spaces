				...
				<div className="w-full flex justify-end relative">
					...
					<div className=" bg-primary absolute left-0 top-14 w-[570px] z-40  py-32 px-14 space-y-5">
						...
						<ul className="font-proximanova3 text-[14px] space-y-5">
							<li>Perfectly located near the EU Commission and with a second venue next to the EU Parliament, blankspace is designed for impactful conferences and corporate meetings.</li>
							<li>Fully equipped with professional AV and a variety of furniture setups, our spaces adapt to suit your event needs. Whether it’s an engaging panel discussion or a strategic meeting, blankspace fosters focus, collaboration, and success. </li>
							<li>Our team ensures every detail is managed, so you can deliver your event with confidence.</li>
						</ul>
