				...
				<div className="w-full flex justify-end relative">
					<div className=" bg-primary absolute left-0 top-14 w-[570px] z-40  py-32 px-14 space-y-5">
						...
						<ul className="font-proximanova3 text-[14px] space-y-5">
							<li>
								From Casa Belgium’s 2024 Spring Collection to Kevin Murphy product showcases,
								blankspace has become a hub for impactful product launches.
							</li>
							<li>
								Whether you're unveiling innovations or celebrating milestones, our spaces elevate
								your brand’s story.{" "}
							</li>

							<li>
								Impress your audience with the perfect blend of professional AV, flexible layouts,
