				...
				<div className="w-full flex justify-end relative">
					...
					<div className=" bg-primary absolute left-0 top-14 w-[570px] z-40  py-32 px-14 space-y-5">
						...
						<ul className="font-proximanova3 text-[14px] space-y-5">
							<li>At blankspace, we’ve proudly hosted countless birthdays and weddings, becoming a go-to venue for those seeking a simple yet cozy design that can be fully customized to their vision. </li>
							<li>Staying true to our philosophy of “blankspace becomes yourspace”, our venue transforms into the perfect setting for your milestone celebrations. </li>
							<li>With all furniture and professional AV equipment provided by our team, planning is effortless, and your focus stays on the joy of the moment. </li>
